...
function renderModalEnsalada(data) {
  ...
  for (let categoria in data.ingredientes) {
    html += `
            <div class="categoria-ingredientes">
                ...
                <div class="row ingredientes-grid">
        `;

    data.ingredientes[categoria].forEach(function (ingrediente) {
      html += `
                <div class="col-lg-3 col-md-4 col-sm-6 ingrediente-item">
                        ...
                        <div class="ingrediente-info">
                            ...
                            ${
                              ingrediente.ingrediente_descripcion
                                ? `<div class="descripcion">${ingrediente.ingrediente_descripcion}</div>`
                                : ""
                            }
  ...
  html += `
        ...
        <div class="modal-footer-ensalada">
