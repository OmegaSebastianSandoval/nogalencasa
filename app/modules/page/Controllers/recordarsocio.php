...
<?php
$registro = strip_tags(trim((string) filter_input(INPUT_GET, 'registro')));
$cedula = strip_tags(trim((string) filter_input(INPUT_GET, 'cedula')));
$error = strip_tags(trim((string) filter_input(INPUT_GET, 'error')));
?>
...
<div class="container">
	<div class="row">
		<div class="col-12 titulo-contact">
			<br>
			<h2 class="contact">Recordar Contraseña</h2>
		</div>
	</div>
</div>
				...
				<div class="col-sm-12 col-md-12 margen_icono">
					<div class="row">
						...
						<div class="col-md-12"><input type="text" name="cedula" required
								class="form-control texto_normal campo_login" value="<?php echo $cedula; ?>" placeholder=""></div>
