				...
				<div class="col-lg-4 form-group">
					...
					<div class="col-sm-12 col-md-12 margen_icono">
						<div class="row">
							...
							<div class="col-md-12"><input type="text" name="cedula" required class="form-control texto_normal campo_login" value="<?php echo $this->cedula; ?>" placeholder="Número de identificación"></div>


							<div class="col-md-12"><input type="text" name="ncar" required class="form-control texto_normal campo_login" value="<?php echo $this->ncar; ?>" placeholder="Número de Acción"></div>
						</div>
					</div>
