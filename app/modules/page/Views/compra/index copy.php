                    ...
                    <div class="caja-pedido">
                        <form action="/page/compra/enviar" method="post" onsubmit="$('#capturarvalortotal').hide();">
                                ...
                                <?php foreach ($this->carrito as $key => $carrito) { ?>
                                    ...
                                    for ($i = 1; $i <= $carrito['cantidad']; $i++) {
                                        ...
                                        if( $carrito['termino_' . $i] != "" ) {
                                            $acompanamientos .= "<span class='cafe'>Término item" . $i . "</span><br>";
                                            ...
                                            <div class="detalle-carrito">
                                                <div class="caja-item">
                                                    <div class="row align-items-center w-100 mx-auto">
                                                        <div class="col-sm-6 col-lg-3 p-lg-0 m-lg-0" align="center">
                                                            <h5 <?php if ($x > 1) {
                                                                    echo 'class="solo_cel"';
                                                                } ?> style=" margin-top:;">&nbsp;</h5>
                                                            <div class="column">
                                                                <div class="caja-img-resumen">
                                                                    <?php if ($producto->productos_imagen != "" and file_exists($_SERVER['DOCUMENT_ROOT'] . "/images/" . $producto->productos_imagen) === true) { ?>
                                                                        <img src="/images/<?php echo ($producto->productos_imagen); ?>" class="img-resumen-producto" alt="<?php echo $producto->productos_nombre; ?>">
                                                                    <?php } else { ?>
                                                                        <img src="/corte/product.png" class="img-resumen-producto" alt="<?php echo $producto->productos_nombre; ?>">
                                                                    <?php } ?>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6 col-lg-3 p-lg-0 m-lg-0">
                                                            <div class="titulo-producto-carrito" align="center">
                                                                ...
                                                                <div class="column">
                                                                    ...
                                                                    <div class="valor-tienda-negocio" style="font-size: 18px;"><?php echo $producto->productos_nombre; ?></div>
                                                                    <?php if ($acompanamientos != "") { ?>
                                                                        <div align="left" class="acompanamientos"><?php echo $acompanamientos; ?></div>
                                                                    <?php } ?>
                                                                </div>

                                                            </div>
                                                           <?php if ($max == 0) { ?>
                                                                <div class="text-center position-absolute" style="margin-top:-26px" id="error2"><small class="alert alert-danger text-center">Producto no disponible</small></div>
                                                                <?php $error = 1; ?>
                                                            <?php } ?>
                                                            <?php if ($carrito['cantidad'] > $max and $max > 0) { ?>
                                                                <div class="text-center  position-absolute" style="margin-top:-26px" id="error3"><small class="alert alert-danger text-center">Solo <?php echo $max; ?> unidad(es) disponible(s)</small></div>
                                                                <?php $error = 1; ?>
                                                            <?php } ?>

                                                        </div>
                                                        <input type="hidden" id="valorunitario<?php echo $producto->productos_id; ?>" value="<?php echo $producto->productos_precio; ?>">
                                                        <div class="col-3 col-lg-2 p-lg-0 m-lg-0" align="center">
                                                            <h5 <?php if ($x > 1) {
                                                                    echo 'class="solo_cel"';
                                                                } ?> >Valor unitario</h5>
                                                            <div class="column">
                                                                ...
                                                                <div class="valor-tienda-negocio">
                                                                    <strong> </strong> <span> $ <?php echo number_format($producto->productos_precio); ?></span>
                                                                </div>
                                                            </div>

                                                        </div>
                                                        <div class="col-4 col-lg-1 p-0 m-0">
                                                            <h5 <?php if ($x > 1) {
                                                                    echo 'class="solo_cel"';
                                                                } ?>>Unidad</h5>
                                                            <div class="column">
                                                                ...
                                                                <div class="input-group input-group-sm" style="">
                                                                    ...
                                                                    <input type="text" class="form-control number cantidad-input" id="cantidad<?php echo $producto->productos_id; ?>" placeholder="" value="<?php echo $carrito['cantidad']; ?>" min="0" max="<?php echo $max; ?>" disabled>
                                                        ...
                                                        <div class="col-3 col-lg-2 p-lg-0 m-lg-0" align="center">
                                                            ...
                                                            <div class="column">
                                                                ...
                                                                <div class="valor-tienda-negocio">
                                                                    <strong></strong> <span id="valortotal<?php echo $producto->productos_id; ?>"> <span> <?php echo number_format((int) $carrito['cantidad'] * (int) $producto->productos_precio); ?></span></span>
                                                                </div>
                                                            </div>
                                                        </div>


                                                        <div class="col-2 col-lg-1 text-right  p-lg-0 m-lg-0">
                                                            <h5 <?php if ($x > 1) {
                                                                    echo 'class="solo_cel"';
                                                                } ?> style=" margin-top:">&nbsp;</h5>
                                                            <div class="column">

                                                                <a class="btn-eliminar-carrito" data-id="<?php echo $producto->productos_id; ?>" onclick="recarga()"><i class="fa-regular fa-trash-can eliminar"></i></a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-12 text-right">
                                            <div class="row">
                                                ...
                                                <div class="valor-total-carrito col-6 col-md-3" id="totalpagar" align="right">
                            ...
                            <?php if ($this->config_propinas->config_tipo != 0) { ?>
                                <hr>
                                <h3 class="titulo-verde1">Propina</h3>
                                ...
                                <?php if ($this->config_propinas->config_tipo == 2) { ?>
                                    ...
                                    <select class="form-control" name="propina" id="propina" onchange="calcular_envio();">
                                        <?php foreach ($this->opciones_propinas as $value) : ?>
                                            <option value="<?php echo $value->opcion_valor; ?>">$ <?php echo number_format($value->opcion_valor); ?></option>
                                        <?php endforeach ?>
                                    </select>
                                <?php } ?>
                                ...
                                <?php if ($this->config_propinas->config_tipo == 3) { ?>
                                    ...
                                    <input type="number" name="propina" id="propina" value="" class="form-control" placeholder="Por favor digite el valor de la propina" readonly>
                                <?php } ?>
                            ...
                            <hr>
                            <div class="caja_gris content-container" data-step="2">

                                <h3 class="titulo-verde1">Información del socio o invitado</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 form-group">
                                        ...
                                        <input type="text" name="pedido_documento" value="<?php if ($this->socio->socio_cedula != "") {
                                                                                            ...
                                                                                            } ?>" id="pedido_documento" class="form-control form-control-sm" required readonly>
                                    </div>
                                    ...
                                    <div class="col-12 margen_info div_direccion">
                                        <h3 class="titulo-verde1">Informacin de envío</h3>
                                    </div>

                                    <div class="direcciones">
                                        <span class="direcciones-guardadas"><i class="fa-solid fa-location-dot"></i>Sus direcciones guardadas</span>
                                        <div class="content-direcciones">
                                            <?php foreach ($this->direcciones as $direccion) { ?>
                                                <div>

                                                    <span class="eliminar-direccion" data-id="<?php echo $direccion->direccion_id; ?>"><i class="fa-solid fa-trash"></i></span>

                                                    <p class="direccion" data-id="<?php echo $direccion->direccion_id; ?>" data-numero1="<?php echo $direccion->direccion_numero1; ?>" data-letra1="<?php echo $direccion->direccion_letra1; ?>" data-numero2="<?php echo $direccion->direccion_numero2; ?>" data-letra2="<?php echo $direccion->direccion_letra2; ?>" data-numero3="<?php echo $direccion->direccion_numero3; ?>" data-complemento="<?php echo $direccion->direccion_complemento; ?>" data-nomenclatura="<?php echo $direccion->direccion_nomenclatura; ?>" data-indicaciones="<?php echo $direccion->direccion_indicaciones; ?>">
                                    ...
                                    <div class="direcciones">
                                        <span class="direcciones-guardadas"><i class="fa-regular fa-circle-user"></i><?php echo $_SESSION['kt_nombre']; ?></span>
                                    ...
                                    <div class="col-lg-10 form-group div_direccion">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <input type="number" class="form-control form-control-sm" name="numero1" id="numero1" placeholder="número" onchange="calcular_envio();" onkeyup="calcular_envio();" min="0" value="" required>
                                                <div class="ejemplo">7</div>
                                            </div>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control form-control-sm" name="letra1" id="letra1" placeholder="letra" value="">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" class="form-control form-control-sm" name="numero2" id="numero2" onchange="calcular_envio();" onkeyup="calcular_envio();" placeholder="número" min="0" value="" required>
                                                <div class="ejemplo">78</div>
                                            </div>
                                            <div class="col-lg-2">
                                                <input type="text" class="form-control form-control-sm" name="letra2" id="letra2" placeholder="letra" value="">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="number" class="form-control form-control-sm" name="numero3" id="numero3" min="0" placeholder="número" value="" required>
                                       ...
                                       <div class="col-lg-4 form-group mt-3">
                                        <label for="">Nombre para facturación eletrónica</label>
                                        <input type="text" name="pedido_nombrefe" id="pedido_nombrefe" class="form-control form-control-sm" required>
                                    </div>
                                    <div class="col-12 col-lg-4 mt-3">
                                        <label for="">Correo para facturación eletrónica</label>
                                        <input type="email" name="pedido_correofe" id="pedido_correofe" class="form-control form-control-sm" required>
                                    </div>
                                    <div class="col-12 col-lg-4 mt-3">
                                        <label for="">Celular de celular</label>
                                        <input type="number" name="pedido_celularfe" id="pedido_celularfe" class="form-control form-control-sm" pattern="[0-9]{1,10}" maxlength="10" title="Ingrese máximo 10 números" required>
                                    </div>


                                    <div class="col-12 mt-3">

                                        <span class="d-block text-guardar">¿Guardar datos para futuras compras?</span>
                                    ...
                                    <div class="col-12">
                                        <div class="mensaje-autorizacion margen_politica">
                                            <div class="form-check" required>
                                                <input class="form-check-input" type="checkbox" id="gridCheck" required><a class="terminos" href="#" data-bs-toggle="modal" data-bs-target="#comoComprar" data-bs-toggle="modal"> Acepto términos y condiciones</a><br><br>

                                                <div class="alert alert-light d-none"><?php echo $this->terminos->contenido_descripcion; ?></div>

                                                <label class="form-check-label" for="gridCheck">
                                                    <div class="modal fade modal-negro" id="ventana" tabindex="-1" aria-labelledby="ventanaLabel" aria-hidden="true">
                                        ...
                                        <div class="mensaje-autorizacion margen_politica" id="div_terminos2" style="display: none;">
                                            <div class="form-check" required>
                                                <input class="form-check-input" type="checkbox" id="gridCheck2" required><a class="terminos" href="#ventana21" data-toggle="modal"> Autorizo cargar a mi acción el valor total del servicio de domicilio (Nogal en casa) solicitado a través de esta plataforma.</a>
                                            ...
                                            <select name="pedido_cuotas" id="pedido_cuotas" class="form-select w-100 w-md-5" aria-label="Default select example">
                                                <option selected disabled value="">Seleccione el número de cuotas...</option>
                                        ...
                                        <div class="row" style="margin-top:30px;">
                                            <div class="col-lg-12 text-end">
                                                <h3 class="titulo-envio">Costo de env&iacute;o: <span id="pedido_enviocosto" class="font-weight-bold"></span></h3><br>
                                                <span class="div_propina">
                                                    <h3 class="titulo-envio">Propina: <span id="pedido_propina1"></span></h3><br>
                                                </span>
                                                <h3 class="titulo-total">Total: <span id="pedido_valorpagar" class="font-weight-bold"></span></h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-danger text-center d-none" role="alert">
                                            Recuerda que si pagas tu pedido despues de las - 12pm, el pedido no se podr procesar el da de hoy </div>
                                            <div class="alert alert-warning text-center d-none" id="alertamonto" role="alert">
                                           El valor total de su pedido debe ser igual o superior a $30,000 COP. </div>
                                        <div class="col-12 d-grid justify-content-center" align="center" id="div-comprar">
                                            <?php if ($_SESSION['kt_accion'] != "00012301" || 1 ==1 ) { ?>
                                                <button type="submit" id="capturarvalortotal" class="btn-pagar">Ir a pagar</button>
                                            <?php } ?>
                                            <div class="pagar-compra" align="right"><a href="/page/index?categoria=1&page=1#a" class="btn btn-sm  btn-primary-carrito btn-primary-carrito-seguir pointer">Seguir comprando</a></div>
