                                                    ...
                                                    <div class="detalle-carrito">
                                                        <div class="caja-item">
                                                            <div class="row align-items-center w-100 mx-auto">
                                                                ...
                                                                <div
                                                                    class="col-sm-12 col-lg-9 p-lg-0 m-lg-0 contenedor-detalles">
                                                                    <div class="row align-items-center w-100 mx-auto h-100 ">
                                                                        <div class="col-12 p-lg-0 m-lg-0">
                                                                            <div class="titulo-producto-carrito" align="center">
                                                                                ...
                                                                                <div class="column">
                                                                                    ...
                                                                                    <span class="valor-tienda-negocio">
                                                                            ...
                                                                            <?php if ($max == 0) { ?>
                                                                                <div class="text-center position-absolute"
                                                                                    style="margin-top:-26px" id="error2"><small
                                                                                        class="alert alert-danger text-center">Producto
                                                                                        no
                                                                            ...
                                                                            <?php if ($carrito['cantidad'] > $max and $max > 0) { ?>
                                                                                <div class="text-center  position-absolute"
                                                                                    style="margin-top:-26px" id="error3"><small
                                                                                        class="alert alert-danger text-center">Solo
                                                                        ...
                                                                        <div class="col-3 col-lg-4 p-lg-0 m-lg-0"
                                                                            align="center">
                                                                            <!-- <h5 <?php if ($x > 1) {
                                                                                            echo 'class="solo_cel"';
                                                                                        } ?>>Valor unitario</h5> -->
                                                                        ...
                                                                        <div class="col-3 col-lg-3 p-lg-0 m-lg-0"
                                                                            align="center">
                                                                            <!-- <h5 <?php if ($x > 1) {
                                                                                            echo 'class="solo_cel"';
                                                                                        } ?>>Valor total</h5> -->
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-12 text-right">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="valor-total-carrito col-6 col-md-3" id="totalpagar"
                                                        align="right">
                                ...
                                <div class="col-12 col-lg-6">
                                        ...
                                        <div class="caja_gris">
                                            ...
                                            <div class="direcciones row w-100 p-2 mx-auto g-1">
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <label class="toggle-switch mx-auto d-block">
                                                ...
                                                <div class="col-12 col-lg-4">
                                                    ...
                                                    <input type="number" name="pedido_celularfe" id="pedido_celularfe"
                                                        class="form-control form-control-sm" pattern="[0-9]{1,10}"
                                                        maxlength="10" title="Ingrese máximo 10 números" required>
                                                </div>
                                    ...
                                    <div class="row" style="margin-top:30px;">
                                        <div class="col-lg-12 text-end">
                                            <h3 class="titulo-envio">Costo de env&iacute;o: <span id="pedido_enviocosto"
                                                    class="font-weight-bold"></span></h3>
                                            <br>
                                            <span class="div_propina">
                                                <h3 class="titulo-envio">Propina: <span id="pedido_propina1"></span>
                                                </h3><br>
                                            </span>
                                            <h3 class="titulo-total">Total: <span id="pedido_valorpagar"
                                                    class="font-weight-bold"></span></h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex justify-content-between align-items-center" align="center"
                                        id="div-comprar">

                                        <div class="pagar-compra" align="right"><a href="/page/index?categoria=1&page=1#a"
                                                class="btn btn-sm  btn-primary-carrito m-0 btn-primary-carrito-seguir pointer">Seguir
                                                comprando</a></div>


                                        <?php if ($_SESSION['kt_accion'] != "00012301" || 1 == 1) { ?>
                                            <button type="submit" id="capturarvalortotal" class="btn-pagar">Ir a
                                                pagar</button>
                                        <?php } ?>
                                    </div>
                                </div>
