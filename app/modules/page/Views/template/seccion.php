<section class="contenedor-seccion contenedor-seccion_<?php echo $contenedor->contenido_id?>" style="background-image:url(/images/<?php echo $contenedor->contenido_fondo_imagen; ?>); background-color:<?php echo $contenedor->contenido_fondo_color; ?>;">
				...
				<?php foreach ($rescontenido['hijos'] as $key => $rescolumna): ?>
					...
					<div class="<?php echo $columna->contenido_columna; ?>">
						...
						<?php } else if($columna->contenido_tipo == 8){ ?>
							<?php $infotcontent = $rescolumna['hijos'] ; ?>
							<?php include(APP_PATH."modules/page/Views/template/productoslogin.php"); ?>
						<?php } else if($columna->contenido_tipo == 9){ ?>
							<?php $infotcontent = $rescolumna['hijos'] ; ?>
							<?php include(APP_PATH."modules/page/Views/template/productosloginresponsive.php"); ?>
						<?php } ?>
					</div>
				<?php endforeach ?>
			</div>
