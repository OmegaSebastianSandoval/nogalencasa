...
class Administracion_contenidoController extends Administracion_mainController
{
	...
	{
		$title = "Administracion de Contenidos";
	...
	public function manageAction()
	{
		...
		if($contentpadre->contenido_tipo == 1){
			...
			$this->_view->tipo = 10;
		} else if($contentpadre->contenido_tipo == 9){
			$this->_view->tipo = 11;
	}
	...
	private function getContenidoseccion()
	{
		...
		//$array['6'] = 'Dnde Ubicarnos';
		$array['10'] = 'Terminos y condiciones';
		$array['11'] = 'Politica tratamiento de datos';
		$array['13'] = 'Carta restaurante express';
		$array['14'] = 'Inicio Delivery';
		$array['15'] = 'Inicio Express';
		$array['16'] = 'Footer';
		$array['17'] = 'Productos login';
		$array['19'] = 'Productos login Responsive';
		$array['18'] = 'Tratamiendo de datos';
		$array['20'] = 'Preguntas frecuentes';
	...
	private function getContenidotipo($idpadre=0,$externo)
	{
		...
		if($padre == 0 || $externo == 1 ){
			...
			$array['6'] = 'Carrousel';
			$array['7'] = 'Acordion';
			$array['8'] = 'Grid productos';
			$array['9'] = 'Grid productos Responsive';
