			...
			<div class="row">
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="productos_descripcion"
							value="<?php echo $this->getObjectVariable($this->filters, 'productos_descripcion') ?>"></input>
					</label>
				</div>
				<div class="col-3 d-none">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="productos_imagen"
							value="<?php echo $this->getObjectVariable($this->filters, 'productos_imagen') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
									...
									<td class="text-right">
										<div>
											<?php if ($_SESSION['kt_login_level'] == "1" or $_SESSION['kt_login_level'] == "3") { ?>
														...
														<a class="btn btn-warning btn-sm" href="/administracion/acompanamientos/?producto=<?= $id ?>"
															data-toggle="tooltip" data-placement="top" title="Acompañamientos"><i
																class="fas fa-user-plus"></i></a>

														<a class="btn btn-info btn-sm" href="/administracion/terminos/?termino_producto=<?= $id ?>"
															data-toggle="tooltip" data-placement="top" title="Términos"><i class="fa-solid fa-bacon"></i></a>
														<?php if ($content->producto_tiene_ingredientes == 1) { ?>

																	<a class="btn btn-warning btn-sm" href="/administracion/ingredientes/?ingrediente_producto=<?= $id ?>"
																		data-toggle="tooltip" data-placement="top" title="Ingredientes"><i class="fa-solid fa-carrot"></i></a>
														<?php } ?>


														<a class="btn btn-verde btn-sm " href="/administracion/fotosproducto/?producto=<?= $id ?>" ment="top"
															data-toggle="tooltip" data-placetitle="Editar"><i class="fas fa-image"></i></a>
