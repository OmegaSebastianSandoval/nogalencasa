			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="archivo_cedulas"
							value="<?php echo $this->getObjectVariable($this->filters, 'archivo_cedulas') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
								...
								<tr>
									...
									<td class="text-right">
										<div>
											...
											<span data-toggle="tooltip" data-placement="top" title="Eliminar" class="d-none"><a
