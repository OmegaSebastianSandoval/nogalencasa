...
<div class="container-fluid">
	<form action="<?php echo $this->route; ?>" method="post">
		<div class="content-dashboard">
			<div class="row">
				<div class="col-3">
					<label>invitacion_socio</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-cafe "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="invitacion_socio"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitacion_socio') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>invitacion_email</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-verde "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="invitacion_email"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitacion_email') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>invitacion_fecha</label>
					<label class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text input-icono fondo-verde-claro "><i class="fas fa-pencil-alt"></i></span>
						</div>
						<input type="text" class="form-control" name="invitacion_fecha"
							value="<?php echo $this->getObjectVariable($this->filters, 'invitacion_fecha') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<div class="content-table">
			<table class=" table table-striped  table-hover table-administrator text-left">
				<thead>
					<tr>
						<td>invitacion_socio</td>
						<td>invitacion_email</td>
						<td>invitacion_fecha</td>
						<td width="100"></td>
					</tr>
				</thead>
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php $id = $content->invitacion_id; ?>
						<tr>
							<td><?= $content->invitacion_socio; ?></td>
							<td><?= $content->invitacion_email; ?></td>
							<td><?= $content->invitacion_fecha; ?></td>
							<td class="text-right">
								<div>
