			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="opcion_valor"
							value="<?php echo $this->getObjectVariable($this->filters, 'opcion_valor') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
								<?php $id = $content->opcion_id; ?>
								<tr>
									<td><?= $content->opcion_valor; ?></td>
									<td>
