				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							...
							<td class="text-right">
								<div>
									<a class="btn btn-verde btn-sm" href="/administracion/categorias/?padre=<?= $id ?>"
										data-toggle="tooltip" data-placement="top" title="Subcategorias"><i
											class="fab fa-microsoft"></i></a>
									<?php if (!$padre) { ?>
										<a class="btn btn-warning btn-sm"
											href="/administracion/productos/?productoscategoria=<?= $id ?>"
											data-toggle="tooltip" data-placement="top" title="Productos"><i
												class="fas fa-shopping-cart"></i></a>
									<?php } else { ?>
										<?php if (count($content->subs) >= 1) { ?>
											<a class="btn btn-warning btn-sm"
												href="/administracion/productos/?productossubcategoriados=<?= $id ?>"
												data-toggle="tooltip" data-placement="top" title="Productos"><i
													class="fas fa-shopping-cart"></i></a>
										<?php } else { ?>
											<a class="btn btn-warning btn-sm"
												href="/administracion/productos/?productossubcategoria=<?= $id ?>"
												data-toggle="tooltip" data-placement="top" title="Productos"><i
													class="fas fa-shopping-cart"></i></a>
										<?php } ?>
