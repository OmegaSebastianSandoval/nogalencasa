			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<select class="form-control" name="config_tipo">
							<option value="">Todas</option>
							<?php foreach ($this->list_config_tipo as $key => $value): ?>
										<option value="<?= $key; ?>" <?php if ($this->getObjectVariable($this->filters, 'config_tipo') == $key) {
												echo "selected";
											} ?>><?= $value; ?></option>
							<?php endforeach ?>
						</select>
				...
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="config_valor_minimo"
							value="<?php echo $this->getObjectVariable($this->filters, 'config_valor_minimo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="config_valor_maximo"
							value="<?php echo $this->getObjectVariable($this->filters, 'config_valor_maximo') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="config_porcentaje"
							value="<?php echo $this->getObjectVariable($this->filters, 'config_porcentaje') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="config_opcional"
							value="<?php echo $this->getObjectVariable($this->filters, 'config_opcional') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>&nbsp;</label>
			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
								...
								<tr>
									<td><?= $this->list_config_tipo[$content->config_tipo]; ?>
									<td><?= $content->config_valor_minimo; ?></td>
									<td><?= $content->config_valor_maximo; ?></td>
									<td><?= $content->config_porcentaje; ?></td>
									<td><?= $content->config_opcional; ?></td>
									<td class="text-right">
										<div>
