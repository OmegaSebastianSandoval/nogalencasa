			...
			<div class="row">
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="log_cedula"
							value="<?php echo $this->getObjectVariable($this->filters, 'log_cedula') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					...
					<label class="input-group">
						...
						<input type="text" class="form-control" name="log_detalle"
							value="<?php echo $this->getObjectVariable($this->filters, 'log_detalle') ?>"></input>
					</label>
				</div>
				<div class="col-3">
					<label>log_log</label>
