...
<div id="todo13" class="container">	
	<div id="tabla13" class="">
		<h2 class="my-3">Clientes nuevos vs Clientes recurrentes</h2>
		<table width="100%" border="1" cellpadding="5" cellspacing="0" class="tabla1">
			<tr>
				<th>Semana</th>
				<th><div align="center">Clientes nuevos</th>
				<th><div align="center">Clientes recurrentes</th>	
			</tr>
	...
	<script type="text/javascript">
		...
		function drawLogScales() {
	      ...
	      data.addColumn('number', 'Clientes nuevos');
	      data.addColumn('number', 'Clientes recurrentes');
	      ...
	      var options = {
	        ...
	        vAxis: {
              ...
              format: '0',
    			...
    			is3D: true,
    			title: 'Clientes nuevos vs Clientes recurrentes'
	      };



	      var chart = new google.visualization.LineChart(document.getElementById('chart_clientes')); 

	    google.visualization.events.addListener(chart, 'ready', titleCenter);
	    chart.draw(data, options);

		function titleCenter() {
		    var $container = $('#chart_clientes');
  	...
  	<div id="chart12" class="mb-2">
		...
		<div id="chart_clientes" style="width: 100%; height: 400px;"></div>
	</div>
</div>