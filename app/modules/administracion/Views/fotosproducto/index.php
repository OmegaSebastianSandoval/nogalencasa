			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						<?php //print_r($content)
						?>
						<?php $id = $content->fotos_productos_id; ?>
						<tr>
							<td>
								<?= $content->producto; ?>
							</td>
							...
							<td>
								<?php if ($content->fotos_productos_imagen) { ?>
									<img src="/images/<?= $content->fotos_productos_imagen; ?>"
										class="img-thumbnail thumbnail-administrator" />
								<?php } ?>
								<div>
									<?= $content->fotos_productos_imagen; ?>
								</div>
							</td>
							<td>
							...
							<td class="text-right">
								<div>
									...
									<span data-toggle="tooltip" data-placement="top" title="Eliminar"><a
