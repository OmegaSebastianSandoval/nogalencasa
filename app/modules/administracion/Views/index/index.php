...
<form autocomplete="off" action="/administracion/loginuser" method="post">
  <div class="row">
    ...
    <div class="form-group my-4">
      ...
      <div class="input-group">
        <input type="password" class="form-control login-input" id="password" name="password" placeholder="Contraseña"
          required>
        <div class="help-block with-errors"></div>
      </div>
    </div>
    ...
    <div class="text-center mt-2"><a href="/administracion/index/olvido" class="olvido">¿Olvidaste tu contraseña?</a>
    </div>
  </div>
</form>