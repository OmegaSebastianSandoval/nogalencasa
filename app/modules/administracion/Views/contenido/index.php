			...
			<table class=" table table-striped  table-hover table-administrator text-left">
				...
				<tbody>
					<?php foreach ($this->lists as $content) { ?>
						...
						<tr>
							<td>
								<?php echo $this->list_contenido_seccion[$content->contenido_seccion]; ?>
							</td>
							<td>
								<?php echo $content->contenido_titulo; ?>
							</td>
							<?php if ($this->padre == 23) { ?>

								<td>
									<?php if ($content->contenido_imagen) { ?>
										<img src="/images/<?= $content->contenido_imagen; ?>" class="img-thumbnail thumbnail-administrator" />
									<?php } ?>
									<div>
							...
							<td class="text-right">
								<div>
									...
									<?php } ?>
									<?php if ($content->contenido_tipo == 6 || $content->contenido_tipo == 7 || $content->contenido_tipo == 8 || $content->contenido_tipo == 9) { ?>
										<a class="btn btn-rosado btn-sm" href="<?php echo $this->route; ?>?padre=<?= $id ?>"
