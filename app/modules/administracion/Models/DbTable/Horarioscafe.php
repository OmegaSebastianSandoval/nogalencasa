...
*/
class Administracion_Model_DbTable_Horarioscafe extends Db_Table
{
	/**
	 * [ nombre de la tabla actual]
	 * @var string
	 */
	protected $_name = 'horarios3';
	...
	public function insert($data){
		...
		$query = "INSERT INTO horarios3( horario_dia, horario_fecha, horario_hora1, horario_hora2) VALUES ( '$horario_dia', '$horario_fecha', '$horario_hora1', '$horario_hora2')";
	...
	public function update($data,$id){
		...
		$horario_hora1 = $data['horario_hora1'];
		$horario_hora2 = $data['horario_hora2'];
		$query = "UPDATE horarios3 SET  horario_dia = '$horario_dia', horario_fecha = '$horario_fecha', horario_hora1 = '$horario_hora1', horario_hora2 = '$horario_hora2' WHERE horario_id = '".$id."'";
		$res = $this->_conn->query($query);
	}
}