...
<div style="background:#FFFFFF; padding:20px;" align="left">
    <div style="display:inline-block; width:900px; padding:20px;">
        ...
        <div style="width: 49%;"><?php echo $this->inscripcion->pedido_nombre . " " . $this->inscripcion->pedido_apellido; ?></div>
        ...
        <br>
        <h2>Informaci&oacute;n de envío</h2>
        <div style="width: 49%;"><b>Forma de envo</b></div>
        <div style="width: 49%;"><?php echo $formas[$this->inscripcion->pedido_forma_envio]; ?></div>
        <?php if ($this->inscripcion->pedido_cuotas >= 1) { ?>
            <br>

            <div style="width: 49%;"><b>Número de cuotas</b></div>
            <div style="width: 49%;"><?php echo $this->inscripcion->pedido_cuotas; ?></div>
        <?php } ?>
        <br>
